...
@Component
public class ListenerLesSub implements RabbitListener<Message> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ListenerLesSub.class);
    ...
    public void receiveMessage(Message message) {
        ...
        try {
            ...
            LOGGER.debug("Receive Message lesson subject: \n"+json);
