                                ...
                                <td>
                                    ...
                                    <c:forEach items="${GroupLessons}" var="lesson">
                                        <c:if test="${lesson.lessonNumber == number && lesson.dayOfWeek == day}">
                                            <c:if
                                                    test="${lesson.weekMode == WeekMode.valueOf('BOTH')
                                                    || lesson.weekMode == WeekMode.values()[Integer.valueOf(week)]}">
                                                <br />
                                                <table>
                                                    <tr>${lesson.subject.title}</tr><br />
                                                    <tr style="font-size:x-small; align-content:flex-end">
                                                            ${lesson.lessonType}</tr><br />
